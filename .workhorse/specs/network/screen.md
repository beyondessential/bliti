...
The application MUST say, beside the hotspot, where it cannot run beside a wireless connection the device reports joined now, naming the connection and its channel and that turning the connection off lets it run, and MUST still let the operator apply.
