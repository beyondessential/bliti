...
The `device-hello` and `client-hello` message types MUST NOT contain any critical members. the client cannot process leaves it without the device's name and version.
