...
export const IN_FORCE = {
	attachments: [
		{ kind: 'wired-static', label: 'Clinic wall port', enabled: true, verify: true, interface: 'eth0', addresses: ['10.4.2.20/24'], gateway: '10.4.2.1' },
		{ kind: 'wired-static', label: 'North site', enabled: true, verify: true, interface: 'eth0', addresses: ['192.168.60.20/24'], gateway: '192.168.60.1', nameservers: ['192.168.60.1'] },
		{ kind: 'wired-dynamic', label: 'eth0 automatic', enabled: true, verify: true, interface: 'eth0' },
